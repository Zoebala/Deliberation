...
class CoursPolicy
{
    ...
    {
        //
        return $user->hasPermissionTo("ViewAny Cours");
    }
    ...
    {
        //
        return $user->hasPermissionTo("View Cours");
    }
    ...
    {
        //
        return $user->hasPermissionTo("Create Cours");
    }
    ...
    {
        //
        return $user->hasPermissionTo("Update Cours");
    }
    ...
    {
        //
        return $user->hasPermissionTo("Delete Cours");
    }
    public function deleteAny(User $user): bool
    {
        //
        return $user->hasPermissionTo("DeleteAny Cours");
    }
